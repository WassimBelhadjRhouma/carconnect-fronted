      ...
      <div className="sm:flex sm:items-center">
        <div className="sm:flex-auto">
          ...
          <p className="mt-2 text-sm text-gray-700">
            Below is a list of car verification requests. Please review the
            details carefully and choose to either accept or refuse each request
...
export default CarOwnershipVerification;
